...
namespace CarFlex.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(CarFlexDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FirstName,LastName,Email,PhoneNumber,Address,DriversLicenseNumber")] Customer customer)
        {
